...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   gui_object_point_i_bundle.c                        :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: bshanae <bshanae@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/18 16:14:09 by bshanae           #+#    #+#             */
/*   Updated: 2019/12/18 16:14:09 by bshanae          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	t_gui_object_point_i_bundle *target, ...)
{
	...
	target->point = va_arg(args, t_gui_object_point_i);
